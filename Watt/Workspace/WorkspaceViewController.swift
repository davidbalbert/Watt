...
class WorkspaceViewController: NSViewController {
    ...
    func makeTableCellView(for column: NSTableColumn, isEditable: Bool) -> NSTableCellView {
        ...
        if let v = outlineView.makeView(withIdentifier: column.identifier, owner: nil) as? NSTableCellView {
            ...
            textField.action = #selector(WorkspaceViewController.submit(_:))
...
extension WorkspaceViewController: WorkspaceDelegate {
...
extension WorkspaceViewController: DirentTextFieldDelegate {
...
extension WorkspaceViewController: NSFilePromiseProviderDelegate {
